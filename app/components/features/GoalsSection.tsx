...
function GoalsSection() {
  return (
    <div className='justify-center bg-gradient-to-b from-[#ffffff] to-[#c8d4ff] pb-5 mt-20 md:mt-30'>
      <div className='text-center'>
        ...
        <p className='w-full font-normal text-xl mb-8 px-5 text-[#010D3E] text-balance md:px-40 md:text-[18px]'>Effortlessly turn your ideas into a fully functional, responsive, no-code SaaS website in just minutes with the set of free components for Framer.</p>
      </div>
      ...
      <div>
        ...
        src={pyramid} 
        alt='pyramid-img' 
        className='hidden md:block md:absolute md:right-0 md:w-32 lg:w-40'
        />
        <Image 
        src={torus} 
        alt='torus-img'
        className='hidden md:block md:absolute md:left-0 md:top-390 md:w-32 lg:w-40'
        />
        ...
        <div className='grid mt-8 mx-auto md:grid-cols-2 md:gap-0'>
