  ...
  return (
    <div className='w-full mt-20'>
        <div className='text-center'>
            ...
            <p className='w-full font-normal text-xl mb-8 px-9 text-[#010D3E] md:px-30 text-balance lg:px-50'>Enjoy customizable lists, team work tools, and smart tracking all in one place. Set tasks, get reminders, and see your progress simply and quickly.</p>
        </div>


        <div className='grid justify-center text-center mt-10 md:mt-15 lg:grid-cols-2 lg:mx-50'>
            {shapes.map((shape: Shapes, i: number) => (
                <div key={i} className='mx-auto max-w-[400px] pt-8 pb-8 mt-5 rounded-xl shadow-[0_4px_10px_-1px_rgba(0,0,0,0.2)] md:max-w-[480px] md:my-5'>
